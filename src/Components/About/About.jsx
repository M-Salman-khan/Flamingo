        ...
        <div id="about">
            <div className="aboutSec">
                ...
                <div className="paraText">
                    <p>At Flamingo Design, we believe fashion is more than clothing — it’s self-expression. Our handcrafted collection is made with care, using organic, 100% cotton fabrics that blend comfort, style, and durability. Whether it’s a casual day out or a special occasion, our designs bring confidence and elegance to every moment.</p>
                </div>
                <div className="icons">
